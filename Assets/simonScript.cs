...
public class simonScript : MonoBehaviour {
    ...
    void Simon()
    {
        ...
        // to see this working, first delete the mat and fontsettings files from the Resources asset folder


        TextAsset selected = Resources.Load<TextAsset>("comicy2"); //(TextAsset)Selection.activeObject;
        //var xx = Resources.FindObjectsOfTypeAll(typeof(TextAsset));
